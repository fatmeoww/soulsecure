...
one port — see [Module2-Docker-Ops.md](Module2-Docker-Ops.md) for full detail
...
| # | Lab | Focus | Docs |
|---|---|---|---|
| 1 | Cloud Asset Discovery | OSINT (RDAP/ASN/CT-log/Shodan), DNS enumeration, full port scanning, shadow IT | [StudentGuide](Module2-Lab1-CloudAssetDiscovery/StudentGuide.md) · [InstructorKey](Module2-Lab1-CloudAssetDiscovery/InstructorKey.md) |
| 2 | DNS & Virtual Host Enumeration | DNS record types (incl. CAA/SRV/AXFR), TLS-SNI vhost brute forcing, TLS SAN enumeration | [StudentGuide](Module2-Lab2-DNS-VHost-Enumeration/StudentGuide.md) · [InstructorKey](Module2-Lab2-DNS-VHost-Enumeration/InstructorKey.md) |
| 3 | API Reconnaissance | Spec discovery, endpoint enumeration, version brute forcing, verbose errors, GraphQL introspection | [StudentGuide](Module2-Lab3-API-Reconnaissance/StudentGuide.md) · [InstructorKey](Module2-Lab3-API-Reconnaissance/InstructorKey.md) |
| 4 | Object Storage Enumeration | Bucket permutation, existence oracles, public bucket looting, multi-cloud (S3 + GCS) | [StudentGuide](Module2-Lab4-Object-Storage-Enumeration/StudentGuide.md) · [InstructorKey](Module2-Lab4-Object-Storage-Enumeration/InstructorKey.md) |
| 5 | CDN, Origin & Technology Fingerprinting | CDN header fingerprinting, origin bypass, robots.txt/security.txt, JS secret leaks, WAF fingerprinting | [StudentGuide](Module2-Lab5-CDN-Origin-Tech-Fingerprinting/StudentGuide.md) · [InstructorKey](Module2-Lab5-CDN-Origin-Tech-Fingerprinting/InstructorKey.md) |

**20 flags total** (3 core + 1 harder-mode bonus per lab), format `flag{md5-hash}`.
Full ground-truth list is in **[Module2-Flags-สรุปทั้งหมด.md](Module2-Flags-สรุปทั้งหมด.md)**
(Thai) — the master answer key.

A Thai-language step-by-step playthrough for all 5 labs is at
**[Module2-คู่มือเล่นแลป-TH.md](Module2-คู่มือเล่นแลป-TH.md)**.
...
[Module2-Docker-Ops.md](Module2-Docker-Ops.md) for the full rationale.
...
```
Full detail in [Module2-Docker-Ops.md](Module2-Docker-Ops.md).
...
(`labctl start 5`). See **[Module2-Docker-Ops.md](Module2-Docker-Ops.md)** for the
